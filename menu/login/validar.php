...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="../../../polar/assets/css/validar.css">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-5">
          ...
          <br>
          <form action="/polar/menu/login/verificar.php" method="POST">
            <div class="mb-3">
            ...
            <div class="m-4 text-center">
              ...
              <a class="btn btn-secondary" href="/polar/php/index.php" role="button">Regresar</a>
            </div>
          </form>
        </div>
      </div>
